    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('web', 'Développement Web'), ('mobile', 'Application Mobile'), ('system', 'Système de Gestion'), ('training', 'Formation'), ('consulting', 'Consulting')], max_length=20, null=True, verbose_name='Catégorie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_featured', models.BooleanField(default=False, help_text="Cocher pour afficher ce service en page d'accueil", verbose_name='Mettre en avant')),
                ('display_order', models.PositiveIntegerField(default=0, verbose_name="Ordre d'affichage")),
            ],
            options={
